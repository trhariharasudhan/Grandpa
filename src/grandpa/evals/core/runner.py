...
from grandpa.evals.core.backend import InferenceBackend
from grandpa.evals.core.dataset import DatasetProvider
from grandpa.evals.core.export import _hardware_info_dict
from grandpa.evals.core.scorer import Scorer
from grandpa.evals.core.tracker import ResultTracker
...
try:
    from grandpa.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from grandpa.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from grandpa.evals.core.dataset import DatasetProvider as _DP
