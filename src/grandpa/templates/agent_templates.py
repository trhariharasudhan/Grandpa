...
def _user_templates_dir() -> Path:
    """Return the path to user-defined templates (~/.grandpa/templates/agents/)."""
    return Path.home() / ".grandpa" / "templates" / "agents"
...
def discover_templates(
    ...
    2. User templates at ``~/.grandpa/templates/agents/``.
