...
Adapted from IPW's ``environment.py``.  Uses Grandpa's
:class:`~grandpa.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Grandpa ``ToolExecutor``.
