...
Recipes are the universal composition format for grandpa.  Each recipe
...
class Recipe:
    ...
    def to_builder_kwargs(self) -> Dict[str, Any]:
        """Convert recipe fields to kwargs for SystemBuilder/grandpa.
    ...
    def to_eval_suite(
        ...
        """
        from grandpa.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from grandpa.recipes.composer import recipe_to_operator
