...
class BaseTool(ABC):
    ...
    def to_openai_function(self) -> Dict[str, Any]:
        ...
        from grandpa.tools.description_loader import (
...
class ToolExecutor:
    ...
    def execute(self, tool_call: ToolCall) -> ToolResult:
        ...
        if taint_set is not None:
            try:
                from grandpa.security.taint import TaintSet, check_taint
        ...
        if result.success:
            try:
                from grandpa.security.taint import auto_detect_taint
