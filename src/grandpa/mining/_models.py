...
from grandpa.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """Grandpa support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "Grandpa before mining is enabled by default."
        ),
    ),
    PearlModelSpec(
