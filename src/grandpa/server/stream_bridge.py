...
from grandpa.agents._stubs import AgentContext, BaseAgent
from grandpa.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("grandpa.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from grandpa.core.types import Message as MsgType
                    from grandpa.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("grandpa.server")
                    _logger.warning(
