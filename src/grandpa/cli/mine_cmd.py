...
from grandpa.mining._models import (
    get_pearl_model_spec,
    iter_pearl_model_specs,
    pearl_variant_for_base_model,
)
from grandpa.mining._stubs import Sidecar
from grandpa.mining.vllm_pearl import ensure_registered as ensure_vllm_registered
...
def _ensure_providers_registered() -> None:
    ...
    from grandpa.mining.cpu_pearl import ensure_registered as ensure_cpu_registered

    ensure_cpu_registered()
    try:
        from grandpa.mining.apple_mps_pearl import (
...
def init(
    ...
    from grandpa.core.config import DEFAULT_CONFIG_PATH
