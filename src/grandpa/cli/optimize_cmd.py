...
def optimize_run(
    ...
    if config_path is not None:
        try:
            from grandpa.learning.optimize.config import load_optimize_config
        except ImportError:
    ...
    if data is not None:
        try:
            from grandpa.learning.optimize.config import load_benchmark_specs
    ...
    try:
        ...
        from grandpa.learning.optimize.config import load_objectives
        ...
        try:
            from grandpa.evals.cli import _build_judge_backend
...
def skills(policy: str, min_traces: int, dry_run: bool) -> None:
    ...
    from grandpa.learning.agents.skill_optimizer import SkillOptimizer
