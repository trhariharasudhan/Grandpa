"""``Grandpa workflow`` — workflow management commands."""
...
def list_workflows() -> None:
    ...
    try:
        from grandpa.workflow.loader import discover_workflows
...
def run(workflow_name: str, input_text: str | None) -> None:
    ...
    try:
        ...
        # Full execution would need a GrandpaSystem — just report for now
        console.print(
