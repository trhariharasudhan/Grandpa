...
def compose_list(kind: Optional[str]) -> None:
    ...
    try:
        from grandpa.recipes.loader import discover_recipes
...
def compose_show(name: str) -> None:
    ...
    console = Console(stderr=True)
    try:
        from grandpa.recipes.loader import resolve_recipe
...
def compose_bench(
    ...
    try:
        ...
        try:
            from grandpa.evals.cli import _run_single
        except ImportError:
...
def compose_stop(name: str) -> None:
    ...
    try:
        ...
        from grandpa.recipes.loader import _PROJECT_OPERATORS_DIR
