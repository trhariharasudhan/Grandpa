...
The internal bus (:mod:`grandpa.core.events`) carries dozens of
...
from grandpa.analytics.redaction import hash_id
from grandpa.core.events import Event, EventType
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from grandpa.analytics.events import KNOWN_TOOL_NAMES
