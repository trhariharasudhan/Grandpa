...
def create_energy_monitor(
    ...
    try:
        from grandpa.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from grandpa.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from grandpa.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from grandpa.telemetry.energy_rapl import RaplEnergyMonitor
