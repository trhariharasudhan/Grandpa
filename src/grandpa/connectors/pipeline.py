...
from grandpa.connectors._stubs import Attachment, Document
from grandpa.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from grandpa.connectors.attachment_store import AttachmentStore
