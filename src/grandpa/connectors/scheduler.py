...
from grandpa.connectors._stubs import BaseConnector
...
class SyncScheduler:
    ...
    ----------
    sync_engine:
        The :class:`~grandpa.connectors.sync_engine.SyncEngine` used to
    ...
    def add(self, connector: BaseConnector) -> None:
        ...
        ----------
        connector:
            Any :class:`~grandpa.connectors._stubs.BaseConnector` instance.
