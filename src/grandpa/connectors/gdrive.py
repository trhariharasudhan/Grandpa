...
Uses OAuth 2.0 tokens stored locally (see :mod:`grandpa.connectors.oauth`).
...
from grandpa.connectors._stubs import BaseConnector, Document, SyncStatus
from grandpa.connectors.google_auth import call_with_refresh
from grandpa.connectors.oauth import (
    GOOGLE_ALL_SCOPES,
...
class GDriveConnector(BaseConnector):
    ...
    credentials_path:
        ...
        ``~/.grandpa/connectors/gdrive.json``.
    """
