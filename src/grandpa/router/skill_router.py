...
_ROUTE_TABLE: dict[str, tuple[str, str, str]] = {
    ...
    "summarize current desktop state": (
        ...
        "desktop_operator_plan",
        "desktop",
    ),
    "detect active app and suggest actions": (
        "desktop.active_app_actions",
        "active_app_actions",
        "desktop",
    ),
    "desktop operator diagnostics": (
        "desktop.operator_diagnostics",
        "desktop_operator_diagnostics",
        "desktop",
    ),
