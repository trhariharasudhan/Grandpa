...
Routes incoming :class:`~grandpa.channels._stubs.ChannelMessage` objects
...
from grandpa.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Grandpa:\nGrandpa://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~grandpa.agents._stubs.BaseAgent`
        subclass).
    max_workers:
