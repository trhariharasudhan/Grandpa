...
# src/grandpa/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m grandpa.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m grandpa.agents.hybrid.runner --cell ${name}"
