...
called from your app startup:
    ...
    from grandpa.agents.proactive_agent import register_cron
...
from grandpa.tools.proactive_tools import get_store
    ...
    if channel_type == "imessage":
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from grandpa.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from grandpa.tools.proactive_tools import (
            CheckPermissionTool,
