...
REAL_WORLD_MENTIONS = [
    # === QUESTIONs that should ground (docs cover them) ===
    {
        ...
        "text": (
            "@grandpaAI does this work with vllm or "
    ...
    },
    {
        ...
        "author": "indie_hacker",
        "text": (
            "@grandpaAI can I run the orchestrator agent "
    ...
    },
    {
        ...
        "author": "macuser",
        "text": "@grandpaAI how do I install on macos with apple silicon?",
    },
    {
        "id": "3000000000000000004",
        "author": "longwinded_lou",
        "text": (
            "@grandpaAI how does the memory system handle "
    ...
    # === QUESTIONs that should defer (off-topic / unknowable) ===
    {
        ...
        "text": "@grandpaAI what's the weather in tokyo today?",
    },
    {
        "id": "3000000000000000006",
        "author": "specific_specs",
        "text": (
            "@grandpaAI what's the exact tokens-per-second "
    ...
    # === BUG / FEATURE / PRAISE / SPAM ===
    {
        ...
        "author": "devops_dan",
        "text": (
            "@grandpaAI getting a segfault on startup "
    ...
    },
    {
        ...
        "text": (
            "@grandpaAI any plans for SSO support? "
    ...
    },
    {
        ...
        "author": "convert_carl",
        "text": (
            "@grandpaAI switched from langchain last week, this is incredible"
        ),
    },
    {
        "id": "3000000000000000010",
        "author": "crypto_bro",
        "text": "@grandpaAI BUY $Grandpa COIN guaranteed 10x gains link in bio",
    },
]
...
def main():
    ...
    j = Grandpa(model=model, engine_key="ollama")
