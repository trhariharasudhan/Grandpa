...
use grandpa_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, grandpa_core::GrandpaError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, grandpa_core::GrandpaError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, grandpa_core::GrandpaError>;

    fn list_models(&self) -> Result<Vec<String>, grandpa_core::GrandpaError>;
...
mod tests {
    use super::*;
    use grandpa_core::{Message, ToolCall};
