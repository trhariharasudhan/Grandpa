//! Grandpa Core — foundation types, registry, config, and event bus.
//!
//! This crate provides the shared data types, configuration loading,
//! component registry, and event bus used by all other Grandpa crates.
...
pub use config::{load_config, GrandpaConfig};
pub use error::GrandpaError;
