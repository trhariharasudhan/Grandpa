...
impl PyMessage {
    pub fn to_core(&self) -> grandpa_core::Message {
        let role = match self.role.as_str() {
            "system" => grandpa_core::Role::System,
            "assistant" => grandpa_core::Role::Assistant,
            "tool" => grandpa_core::Role::Tool,
            _ => grandpa_core::Role::User,
        };
        grandpa_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: grandpa_core::GrandpaConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: grandpa_core::GrandpaConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<grandpa_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(grandpa_core::EventBus::new(true)),
        }
    }
