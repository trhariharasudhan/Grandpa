...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'Grandpa-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'Grandpa-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to Grandpa servers</span>
          )}
        </div>
      </div>
    </div>
