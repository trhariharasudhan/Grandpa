...
class TestDetectHardware:
    ...
    @patch("grandpa.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "grandpa.core.config._run_cmd",
    ...
    @patch("grandpa.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "grandpa.core.config._run_cmd",
        side_effect=[
    ...
    @patch("grandpa.core.config.platform.system", return_value="Darwin")
    @patch(
        "grandpa.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("grandpa.core.config.shutil.which", return_value=None)
    @patch("grandpa.core.config.platform.system", return_value="Linux")
