"""Tests for grandpa.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from grandpa.evals.core.types import RunConfig, RunSummary
from grandpa.learning.optimize.trial_runner import TrialRunner
from grandpa.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "Grandpa-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "Grandpa-direct"
...
class TestRunTrial:
    ...
    @patch("grandpa.evals.cli._build_scorer")
    @patch("grandpa.evals.cli._build_judge_backend")
    @patch("grandpa.evals.cli._build_dataset")
    @patch("grandpa.evals.cli._build_backend")
    @patch("grandpa.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from grandpa.evals.core.types import EvalResult
