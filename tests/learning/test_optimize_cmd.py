"""Smoke tests for ``Grandpa optimize`` and ``Grandpa feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in GrandpaConfig."""

    def test_optimize_config_in_Grandpa_config(self):
        from grandpa.core.config import GrandpaConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from grandpa.core.config import OptimizeConfig
...
class TestTraceStoreUpdateFeedback:
    ...
    def test_update_feedback_success(self, tmp_path):
        from grandpa.core.types import Trace
