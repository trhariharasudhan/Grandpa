...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from grandpa.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from grandpa.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from grandpa.core.config import GRPOConfig
        from grandpa.learning.intelligence.grpo_trainer import GRPOTrainer
