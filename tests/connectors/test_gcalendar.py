...
def connector(tmp_path: Path):
    ...
    from grandpa.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "grandpa.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("grandpa.connectors.gcalendar._gcal_api_calendars_list")
@patch("grandpa.connectors.gcalendar._gcal_api_events_list")
