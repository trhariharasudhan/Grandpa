...
def connector(tmp_path: Path):
    ...
    from grandpa.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("grandpa.connectors.gdrive._gdrive_api_list_files")
@patch("grandpa.connectors.gdrive._gdrive_api_export")
