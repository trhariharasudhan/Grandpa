...
def connector(tmp_path: Path):
    ...
    from grandpa.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("grandpa.connectors.dropbox._dropbox_api_list_folder")
@patch("grandpa.connectors.dropbox._dropbox_api_download")
