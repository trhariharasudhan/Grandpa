...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from grandpa.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from grandpa.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from grandpa.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from grandpa.connectors.google_tasks import GoogleTasksConnector
