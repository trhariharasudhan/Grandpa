...
_LOCAL_CONNECTORS = [
    ("apple_notes", "grandpa.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "grandpa.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "grandpa.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "grandpa.connectors.outlook", "OutlookConnector"),
    ("slack", "grandpa.connectors.slack_connector", "SlackConnector"),
    ("notion", "grandpa.connectors.notion", "NotionConnector"),
    ("granola", "grandpa.connectors.granola", "GranolaConnector"),
    ("gdrive", "grandpa.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "grandpa.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "grandpa.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "grandpa.connectors.dropbox", "DropboxConnector"),
]
