"""Verify GrandpaAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestGrandpaAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        ...
        with patch("grandpa.system.SystemBuilder") as MockSB:
            ...
            backend = GrandpaAgentBackend(model="qwen-9b")
