...
from grandpa.evals.core.event_recorder import AgentEvent, EventType
from grandpa.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from grandpa.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """grandpa tool names are mapped to PinchBench-expected names."""
    from grandpa.evals.scorers.pinchbench import events_to_transcript
