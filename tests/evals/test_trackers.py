...
def _make_config(**overrides) -> RunConfig:
    defaults = dict(benchmark="test", backend="Grandpa-direct", model="test-model")
...
class TestWandbTracker:
    ...
    def test_import_error_when_wandb_missing(self):
        ...
        with patch.dict(sys.modules, {"wandb": None}):
            import grandpa.evals.trackers.wandb_tracker as wt_mod
...
class TestSheetsTracker:
    ...
    def test_import_error_when_gspread_missing(self):
        ...
        import grandpa.evals.trackers.sheets_tracker as st_mod
