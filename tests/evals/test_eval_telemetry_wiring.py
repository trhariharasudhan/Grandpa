...
- GrandpaDirectBackend propagates gpu_metrics flag
...
from grandpa.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from grandpa.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from grandpa.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# GrandpaDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify GrandpaDirectBackend sets gpu_metrics on config."""

    @patch("grandpa.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("grandpa.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from grandpa.evals.core.config import expand_suite
        from grandpa.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,
