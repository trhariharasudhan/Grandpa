"""Tests for GrandpaAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestGrandpaAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(GrandpaAgentBackend.__init__)
