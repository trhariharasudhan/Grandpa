"""Tests for the Rich display helpers in grandpa.evals.core.display."""
...
from grandpa.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "grandpa" in output or "___" in output
