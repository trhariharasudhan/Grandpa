...
from grandpa.core.config import CapabilitiesConfig, GrandpaConfig, SecurityConfig
from grandpa.core.events import EventBus
from grandpa.security import SecurityContext, setup_security
...
def _make_config(*, enabled: bool = True, caps_enabled: bool = False) -> GrandpaConfig:
    cfg = GrandpaConfig()
