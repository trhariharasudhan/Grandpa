...
_PATCH_HTTP = "grandpa.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "grandpa.mcp.transport.StdioTransport"
_PATCH_CLIENT = "grandpa.mcp.client.MCPClient"
_PATCH_PROVIDER = "grandpa.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "grandpa.system.builder.logger"
