...
class TestCliInstallE2E:
    def test_install_hermes_skill_e2e(self, tmp_path: Path) -> None:
        """Grandpa skill install hermes:research-skill installs to target dir."""
        from grandpa.skills.sources.hermes import HermesResolver
        ...
        with patch(
            ...
            with patch.object(HermesResolver, "sync", lambda self: None):
                ...
                # ~/.grandpa/skills/.
                from grandpa.skills.importer import SkillImporter as _SI
