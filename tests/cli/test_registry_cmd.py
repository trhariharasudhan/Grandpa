"""Tests for the ``Grandpa registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the Grandpa registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "grandpa.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"grandpa.core.registry": None}):
