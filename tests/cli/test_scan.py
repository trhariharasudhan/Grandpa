"""Tests for ``Grandpa scan`` privacy scanner CLI command."""
...
from grandpa.cli.scan_cmd import PrivacyScanner, ScanResult
...
class TestJsonOutput:
    ...
    def test_json_output_structure(self) -> None:
        ...
        runner = CliRunner()
        with patch(
            "grandpa.cli.scan_cmd.PrivacyScanner.run_all",
            return_value=[
