"""Tests for model resolution fallback chain in Grandpa ask."""
...
def _register_agents():
    ...
    The default ``GrandpaConfig().agent.default_agent`` is ``"simple"``,
    so ``Grandpa ask "..."`` (without ``--agent``) routes through SimpleAgent.
