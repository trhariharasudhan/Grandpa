"""Tests for ``Grandpa ask --agent`` CLI integration."""
...
def mock_setup():
    ...
    with (
        ...
        mock_cfg.return_value = GrandpaConfig()
...
class TestAskAgentOption:
    ...
    def test_no_agent_flag_falls_back_to_config_default_agent(
        ...
        ``Grandpa ask "..."`` should route through SimpleAgent rather than
...
class TestPersonaFilesReachModel:
    ...
    def test_soul_md_content_reaches_engine_in_simple_agent(
        ...
        soul.write_text("PERSONA_SENTINEL_zh_Grandpa", encoding="utf-8")
        ...
        assert "PERSONA_SENTINEL_zh_Grandpa" in joined
