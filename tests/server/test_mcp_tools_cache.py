...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("grandpa.mcp.transport.StreamableHTTPTransport"),
        patch("grandpa.mcp.client.MCPClient"),
        patch("grandpa.tools.mcp_adapter.MCPToolProvider") as MockProvider,
    ):
