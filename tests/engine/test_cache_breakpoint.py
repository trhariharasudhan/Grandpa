...
def test_anthropic_cache_breakpoint_added():
    from grandpa.engine.cloud import _annotate_anthropic_cache

    messages = [
        {"role": "system", "content": "You are Grandpa. ## Persona\nHelpful assistant."},
...
def test_already_list_content_gets_cache_control():
    ...
    messages = [
        {"role": "system", "content": [{"type": "text", "text": "You are Grandpa."}]},
    ]
    annotated = _annotate_anthropic_cache(messages)
