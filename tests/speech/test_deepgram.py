...
from grandpa.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("grandpa.speech.deepgram.DeepgramClient", return_value=mock_client):
        from grandpa.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("grandpa.speech.deepgram.DeepgramClient"):
        from grandpa.speech.deepgram import DeepgramSpeechBackend
