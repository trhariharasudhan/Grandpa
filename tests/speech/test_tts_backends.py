...
def test_cartesia_registered():
    from grandpa.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "grandpa.speech.cartesia_tts._cartesia_synthesize",
...
def test_openai_tts_registered():
    from grandpa.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "grandpa.speech.openai_tts._openai_tts_request",
