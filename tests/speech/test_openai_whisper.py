...
from grandpa.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("grandpa.speech.openai_whisper.OpenAI", return_value=mock_client):
        from grandpa.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("grandpa.speech.openai_whisper.OpenAI"):
        from grandpa.speech.openai_whisper import OpenAIWhisperBackend
