...
from grandpa.bench.energy import EnergyBenchmark
from grandpa.core.registry import BenchmarkRegistry
from grandpa.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from grandpa.bench.energy import ensure_registered
