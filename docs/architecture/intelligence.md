...
```python
from grandpa.intelligence import merge_discovered_models
...
The following names are still importable from `grandpa.intelligence` via shim modules, but their canonical locations have moved:
