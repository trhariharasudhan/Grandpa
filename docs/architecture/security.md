...
The default path is `~/.grandpa/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/grandpa/security/index.md) — complete class and function signatures
